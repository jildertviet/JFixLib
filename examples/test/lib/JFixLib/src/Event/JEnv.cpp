...
void JEnv::trigger(unsigned short a, unsigned short s, unsigned short r,
                   float b, float bias) {
  duration = a + s + r;
  this->a = a;
  this->s = s;
...
void JEnv::trigger(float *ptr, unsigned short a, unsigned short s,
                   unsigned short r, float b, float bias) {
  writePtr = ptr;
